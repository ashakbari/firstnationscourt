...
- Design language: editorial print. Warm paper, ink-forward type, hairline rules (--rule), letterpress ink buttons, numbered ledger rows for steps, small-caps labels for nav and metadata, the ring-of-dots mark as a quiet watermark. No rounded-card grids with drop shadows, no gradient fills, no pill buttons.
